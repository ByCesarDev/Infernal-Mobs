...
foreach ($comMojang in $comMojangPaths) {
    ...
    # Behavior Pack Link
    $bpTarget = Join-Path $comMojang "development_behavior_packs\Infernal Mobs BP"
    $bpSource = Join-Path $repo "InfernalMobsBedrock-source\Infernal Mobs BP"
    ...
    # Resource Pack Link
    $rpTarget = Join-Path $comMojang "development_resource_packs\Infernal Mobs RP"
    $rpSource = Join-Path $repo "InfernalMobsBedrock-source\Infernal Mobs RP"
